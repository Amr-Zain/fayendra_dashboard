...
function FilePreview({
  ...
  if (shapeType === "picture-card") {
    return (
      <div key={file.uid} className="relative group bg-card border rounded-lg p-2 hover:shadow-md transition-all">
  ...
  // List view
  return (
    <div key={file.uid} className="flex items-center p-3 bg-card border rounded-lg hover:shadow-sm transition-shadow">
